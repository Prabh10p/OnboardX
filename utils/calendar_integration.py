...
class CalendarIntegration:
    ...
    def generate_google_calendar_link(self, meeting_data):
        ...
        url = f"{base_url}&text={title}&dates={start_str}/{end_str}&details={description}&location={location}"
        return url
    ...
    def generate_outlook_calendar_link(self, meeting_data):
        ...
        url = (
            f"{base_url}?subject={title}&startdt={start_str}&enddt={end_str}"
            f"&body={description}&location={location}"
        )
        return url
